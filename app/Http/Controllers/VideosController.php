...
class VideosController extends Controller
{
    ...
    {   
    	...
    	$videos = DB::select('select p.id as id, p.titulo as titulo, p.descripcion as descripcion, Observacion, archivo, url  from asignatura a, publicacion p, profesor_asignatura pa where '.$id.'=pa.id_asignatura and p.id_profesor='.$id_usuario.' and p.id_tipo_publicacion = 3 group by p.id');
    ...
    */
    ...
    public function store(VideoRequest $request)
    {
       ...
       \Storage::disk('local')->put($nombre,  \File::get($file));
        ...
        //dd($asignaturas);
        $videos->save();
        Flash::success('El vídeo ' . $videos->titulo . ' ha sido guardado con éxito!');
     ...
     public function update(request $request,$id)
    {
        ...
        return redirect("admin/videos/" . $id_asignatura);
    }
